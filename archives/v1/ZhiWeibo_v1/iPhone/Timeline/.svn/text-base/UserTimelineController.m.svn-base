...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
	if (self = [super initWithNibName:nibNameOrNil bundle:nibBundleOrNil]) {
		...
		dataSource = [[UserTimelineDataSource_Phone alloc]initWithTableView:pullRefreshTableView];
...
- (void)tweetSelected:(Status *)status {
	TweetViewController *tweetView = [[[TweetViewController alloc] initWithNibName:@"TweetViewController" bundle:nil] autorelease];
