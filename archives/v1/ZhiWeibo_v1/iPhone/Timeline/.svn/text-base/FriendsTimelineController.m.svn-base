...
- (id)initWithCoder:(NSCoder *)aDecoder {
	if (self = [super initWithCoder:aDecoder]) {
		...
		//self.dataSource = [[FriendsTimelineDataSource_Phone alloc]initWithTableView:pullRefreshTableView];
		//self.dataSource.statusDataSourceDelegate = self;	
...
- (FriendsTimelineDataSource_Phone *)dataSource {
	...
	PullRefreshTableView *pullRefreshTableView = (PullRefreshTableView *)self.tableView;
	dataSource = [[FriendsTimelineDataSource_Phone alloc]initWithTableView:pullRefreshTableView];
