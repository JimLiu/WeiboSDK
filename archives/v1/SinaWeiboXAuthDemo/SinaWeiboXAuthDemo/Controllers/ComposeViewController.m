...
- (void)postNewStatus
{
	SinaWeiboClient *client = [[SinaWeiboClient alloc] initWithDelegate:self action:@selector(postStatusDidSucceed:obj:)];
...
- (void)postStatusDidSucceed:(SinaWeiboClient*)sender obj:(NSObject*)obj;
{
	Draft *sentDraft = nil;
